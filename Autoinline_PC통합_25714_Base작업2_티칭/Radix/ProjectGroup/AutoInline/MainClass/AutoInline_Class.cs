                ...
                try
                {
                    ...
                    if (GlobalVar.SystemStatus >= enumSystemStatus.AutoRun)
                    {
                        if (GlobalVar.SystemStatus >= enumSystemStatus.AutoRun)
                        {
                            ...
                            for (FuncInline.enumServoAxis axis = FuncInline.enumServoAxis.SV00_In_Shuttle; axis <= FuncInline.enumServoAxis.SV07_Scan_Y; axis++)
                            {
                        ...
                        //호밍 중일때 센서 감지시 즉시 정지
                        //int SV00_BeforeLift = (int)FuncInline.enumServoAxis.SV00_Input_Tray_Lift;
