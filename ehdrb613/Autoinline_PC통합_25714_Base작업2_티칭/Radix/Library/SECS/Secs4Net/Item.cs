...
namespace Secs4Net {
    ...
    public sealed class Item : MarshalByRefObject {
        ...
        readonly ReadOnlyCollection<Item> _list;  //  List는 Format이 List인 경우만 값을 가지면, 아니면 null
        readonly object _value;      //  Format이 List가 아닌 경우 _value에는 값이 있고, 아니면 null (문자열 또는 배열)
