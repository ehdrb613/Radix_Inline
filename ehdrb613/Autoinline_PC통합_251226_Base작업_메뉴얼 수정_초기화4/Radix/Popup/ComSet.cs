    ...
    public partial class ComSet : Form
    {
        ...
        private void LoadAllValue()
        {
            try
            {
                ...
                for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                {
                    debug("cmbPort" + ((FuncInline.enumLetsMotion)i).ToString());
                    ComboBox portSite = (ComboBox)Controls.Find("cmbPort" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
                    Util.SetComboIndex(ref portSite, "COM" + FuncInline.PortPMC[i].ToString());

                    ComboBox baudSite = (ComboBox)Controls.Find("cmbBaud" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
                    Util.SetComboIndex(ref baudSite, FuncInline.BaudPMC[i].ToString());

                    ComboBox paritySite = (ComboBox)Controls.Find("cmbParity" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
                    Util.SetComboIndex(ref paritySite, FuncInline.ParityPMC[i].ToString());

                    ComboBox stopSite = (ComboBox)Controls.Find("cmbStopBits" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
        ...
        private void ApplyAllValue()
        {
            try
            {
                ...
                for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                {
                    ...
                    ComboBox stopBitsSite = (ComboBox)Controls.Find("cmbStopBits" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
        ...
        private void Setting_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                {
                    ((ComboBox)Controls.Find("cmbPort" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Clear();
                    ((ComboBox)Controls.Find("cmbPort" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.AddRange(ports);
                    ((ComboBox)Controls.Find("cmbPort" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).SelectedIndex = 0;
                }
                #endregion
                ...
                for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                {
                    ((ComboBox)Controls.Find("cmbBaud" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Clear();
                }
                ...
                for (int j = 0; j < arrBaud.Length; j++)
                {
                    ...
                    for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                    {
                        ((ComboBox)Controls.Find("cmbBaud" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Add(arrBaud.GetValue(j).ToString().Replace("Baud", ""));
                        ((ComboBox)Controls.Find("cmbBaud" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).SelectedIndex = 0;
                    }
                }
                #endregion
                ...
                for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                {
                    ((ComboBox)Controls.Find("cmbParity" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Clear();
                }
                ...
                for (int j = 0; j < arrParity.Length; j++)
                {
                    ...
                    for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                    {
                        ((ComboBox)Controls.Find("cmbParity" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Add(arrParity.GetValue(j));
                        ((ComboBox)Controls.Find("cmbParity" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).SelectedIndex = 0;
                    }
                }
                #endregion
                ...
                for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                {
                    ((ComboBox)Controls.Find("cmbStopBits" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Clear();
                }
                ...
                for (int j = 0; j < arrStopBits.Length; j++)
                {
                    ...
                    for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
                    {
                        ((ComboBox)Controls.Find("cmbStopBits" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).Items.Add(arrStopBits.GetValue(j));
                        if (j > 0)
                        {
                            ((ComboBox)Controls.Find("cmbStopBits" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0]).SelectedIndex = 1;
                        }
                    }
                }
                #endregion
        ...
        private bool CheckPortDupe() // 전체 포트 설정에 겹치는 부분이 있는가? 경고만 하고 적용은 한다.
        {
            ...
            {
                ComboBox portSite = (ComboBox)Controls.Find("cmbPort" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
                for (int j = i + 1; j < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; j++)
                {
                    ComboBox portSite2 = (ComboBox)Controls.Find("cmbPort" + ((FuncInline.enumLetsMotion)j).ToString(), true)[0];
        ...
        private void pbApply_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Enum.GetValues(typeof(FuncInline.enumLetsMotion)).Length; i++)
            {
                ComboBox cmb = (ComboBox)Controls.Find("cmbStopBits" + ((FuncInline.enumLetsMotion)i).ToString(), true)[0];
                if ((cmb).Text == "None")
                {
                    cmb.Focus();
                    FuncWin.TopMessageBox("StopBits None not supported");
