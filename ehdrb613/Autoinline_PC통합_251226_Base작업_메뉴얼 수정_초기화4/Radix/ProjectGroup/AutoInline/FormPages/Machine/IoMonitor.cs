...
namespace Radix.Popup.Machine
{
    ...
    public partial class IoMonitor : Form
    {
        ...
        private void IoMonitor_Shown(object sender, EventArgs e)
        {
            ...
            //FuncLog.WriteLog("di count : " + dis.Length);
        ...
        private void tmrIO_Tick(object sender, EventArgs e)
        {
            if (FuncInline.TabMain != FuncInline.enumTabMain.Machine ||
                     FuncInline.TabMachine != FuncInline.enumTabMachine.IoMonitor) // 메인 탭이 다른 곳에 있으면 실행 안 한다.
            {
                return;
            }
