...
namespace Radix.Popup.Manual
{
    ...
    public partial class Site : Form
    {
            ...
            try
            {
                    ...
                    this.InvokeRequired)
                {
                    this.Invoke(new MethodInvoker(delegate ()
                    {
                        ...
                        if (FuncInline.SiteIoMaps.TryGetSiteMotor(manualPos, out var motorCwDo, out var motorCcwDo))
                        {
                        ...
                        btnSite1.BackColor = siteIndex == 0 ? Color.Lime :
                                        !FuncInline.UseSite[0] ? Color.LightGray : Color.White;
                        btnSite2.BackColor = siteIndex == 1 ? Color.Lime :
                                        !FuncInline.UseSite[1] ? Color.LightGray : Color.White;
                        btnSite3.BackColor = siteIndex == 2 ? Color.Lime :
                                        !FuncInline.UseSite[2] ? Color.LightGray : Color.White;
                        btnSite4.BackColor = siteIndex == 3 ? Color.Lime :
                                        !FuncInline.UseSite[3] ? Color.LightGray : Color.White;
                        btnSite5.BackColor = siteIndex == 4 ? Color.Lime :
                                        !FuncInline.UseSite[4] ? Color.LightGray : Color.White;
                        btnSite6.BackColor = siteIndex == 5 ? Color.Lime :
                                        !FuncInline.UseSite[5] ? Color.LightGray : Color.White;
                        btnSite7.BackColor = siteIndex == 6 ? Color.Lime :
                                        !FuncInline.UseSite[6] ? Color.LightGray : Color.White;
                        btnSite8.BackColor = siteIndex == 7 ? Color.Lime :
                                        !FuncInline.UseSite[7] ? Color.LightGray : Color.White;
                        btnSite9.BackColor = siteIndex == 8 ? Color.Lime :
                                        !FuncInline.UseSite[8] ? Color.LightGray : Color.White;
                        btnSite10.BackColor = siteIndex == 9 ? Color.Lime :
                                        !FuncInline.UseSite[9] ? Color.LightGray : Color.White;
                        btnSite11.BackColor = siteIndex == 10 ? Color.Lime :
                                        !FuncInline.UseSite[10] ? Color.LightGray : Color.White;
                        btnSite12.BackColor = siteIndex == 11 ? Color.Lime :
                                        !FuncInline.UseSite[11] ? Color.LightGray : Color.White;
                        btnSite13.BackColor = siteIndex == 12 ? Color.Lime :
                                        !FuncInline.UseSite[12] ? Color.LightGray : Color.White;
                        btnSite14.BackColor = siteIndex == 13 ? Color.Lime :
                                        !FuncInline.UseSite[13] ? Color.LightGray : Color.White;
                        btnSite15.BackColor = siteIndex == 14 ? Color.Lime :
                                        !FuncInline.UseSite[14] ? Color.LightGray : Color.White;
                        btnSite16.BackColor = siteIndex == 15 ? Color.Lime :
                                        !FuncInline.UseSite[15] ? Color.LightGray : Color.White;
                        btnSite17.BackColor = siteIndex == 16 ? Color.Lime :
                                        !FuncInline.UseSite[16] ? Color.LightGray : Color.White;
                        btnSite18.BackColor = siteIndex == 17 ? Color.Lime :
                                        !FuncInline.UseSite[17] ? Color.LightGray : Color.White;
                        btnSite19.BackColor = siteIndex == 18 ? Color.Lime :
                                        !FuncInline.UseSite[18] ? Color.LightGray : Color.White;
                        btnSite20.BackColor = siteIndex == 19 ? Color.Lime :
                                        !FuncInline.UseSite[19] ? Color.LightGray : Color.White;
                        btnSite21.BackColor = siteIndex == 20 ? Color.Lime :
                                        !FuncInline.UseSite[20] ? Color.LightGray : Color.White;
                        btnSite22.BackColor = siteIndex == 21 ? Color.Lime :
                                        !FuncInline.UseSite[21] ? Color.LightGray : Color.White;
                        btnSite23.BackColor = siteIndex == 22 ? Color.Lime :
                                        !FuncInline.UseSite[22] ? Color.LightGray : Color.White;
                        btnSite24.BackColor = siteIndex == 23 ? Color.Lime :
                                        !FuncInline.UseSite[23] ? Color.LightGray : Color.White;
                        btnSite25.BackColor = siteIndex == 24 ? Color.Lime :
                                        !FuncInline.UseSite[24] ? Color.LightGray : Color.White;
                        btnSite26.BackColor = siteIndex == 25 ? Color.Lime :
                                        !FuncInline.UseSite[25] ? Color.LightGray : Color.White;
                        ...
                        #region 세대별 텍스트명 변경
                        // PCB 감지 표시 버튼들을 배열로 모아서 루프 처리
                        Button[] pcbBtnsSite = new Button[]
                        {
                            btnSite1,  btnSite2,  btnSite3,  btnSite4,  btnSite5,  btnSite6,
                            btnSite7,  btnSite8,  btnSite9,  btnSite10, btnSite11, btnSite12,
                            btnSite13, btnSite14, btnSite15, btnSite16, btnSite17, btnSite18,
                            btnSite19, btnSite20, btnSite21, btnSite22, btnSite23, btnSite24,
                            btnSite25, btnSite26
                        };
                        // 세대별 사이트 수(MaxSiteCount)에 맞춰 안전하게 처리
                        count = Math.Min(pcbBtnsSite.Length, FuncInline.MaxSiteCount);
                        for (int i = 0; i < count; i++)
                        {
                            int.TryParse(pcbBtnsSite[i].Name.Replace("btnSite", ""), out countindex);
                            countindex--;
                            FuncInline.enumTeachingPos pos = (FuncInline.enumTeachingPos)((int)FuncInline.enumTeachingPos.Site1_F_DT1 + countindex);
                            //세대별 사이트 명칭 변경
                            string label = FuncInline.SiteDisplay.GetSiteDisplayName(pos);

                            pcbBtnsSite[i].Text = label;
                        }
                        #endregion
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            /*
            // PCB 투입 상태로 기동시 상태
            //GlobalVar.LetsAxisStatus[(int)FuncInline.enumPMCAxis.Site1].Position =
