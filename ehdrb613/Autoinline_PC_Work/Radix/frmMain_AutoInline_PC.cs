...
namespace Radix
{
    public partial class frmMain_AutoInline_PC : Form
    {
        ...
        private void frmMain_Shown(object sender, EventArgs e) // 화면 출력시
        {
            ...
            FuncLog.WriteLog("Version - " + Application.ProductVersion);
            ...
            int firstScreen = -1;
            int secondScreen = -1;
            if (sc[0].Bounds.Width == 1920)
            {
                firstScreen = 0;
                secondScreen = 1;
            }
            else if (sc.Length > 1 &&
                sc[1].Bounds.Width == 1920)
            {
                firstScreen = 1;
                secondScreen = 0;
            }
            ...
            GlobalVar.ScreenNumbers[0] = firstScreen;
            if (sc.Length > 1)
            {
                GlobalVar.ScreenNumbers[1] = secondScreen;
            }
            #endregion
            #endregion
            ...
            dlgLoading.Show();
            dlgLoading.Left = sc[firstScreen].Bounds.Right / 2 - dlgLoading.Width / 2;
            dlgLoading.Top = sc[firstScreen].Bounds.Bottom / 2 - dlgLoading.Height / 2;

            FuncInline.InitDone[(int)FuncInline.enumLoading.SubForms] = true;
            FuncInline.InitDone[(int)FuncInline.enumLoading.WindowForms] = true;
            ...
            GlobalVar.Class = new AutoInline();      //프로젝트 클레스
            ...
            dataGridModel.Rows.Add("Model", "");
            dataGridModel.Rows.Add("Width", "");
            dataGridModel.Rows.Add("Length", "");
            dataGridModel.Rows.Add("Test Method", "");
            dataGridModel.Rows.Add("Timeout", "");
            dataGridModel.Rows.Add("Array", "");
            dataGridModel.Rows.Add("XOut Select", "");
            dataGridModel.Rows.Add("Vision XOut", "");
            dataGridModel.Rows.Add("Vision BadMark", "");
            dataGridModel.Rows.Add("", "");
            dataGridModel.Rows[9].Selected = true;

            dataGridCount.Rows.Clear();
            dataGridCount.Rows.Add("Shift", "PBA", "PCB");
            dataGridCount.Rows.Add("Input", "", "");
            dataGridCount.Rows.Add("Pass", "", "");
            dataGridCount.Rows.Add("Defect", "", "");
            dataGridCount.Rows.Add("Defect Rate", "", "");
            dataGridCount.Rows.Add("", "", "");
            dataGridCount.Rows[5].Selected = true;

            #region 폰트가 자꾸 날아가서 강제 할당
            GlobalVar.dataGridStyle.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
            GlobalVar.dataGridStyle.BackColor = Color.White;
            GlobalVar.dataGridStyle.Font = new System.Drawing.Font("Calibri", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            GlobalVar.dataGridStyle.ForeColor = System.Drawing.SystemColors.WindowText;
            GlobalVar.dataGridStyle.SelectionBackColor = System.Drawing.SystemColors.Highlight;
            GlobalVar.dataGridStyle.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
            GlobalVar.dataGridStyle.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
            dataGridCount.DefaultCellStyle = GlobalVar.dataGridStyle;
            #endregion

            dataGridSystem.Rows.Clear();
            dataGridSystem.Rows.Add("Cooling", "");
            dataGridSystem.Rows.Add("Site Block", "");
            dataGridSystem.Rows.Add("Defect Block", "");
            dataGridSystem.Rows.Add("Self Retest", "");
            dataGridSystem.Rows.Add("Resite", "");
            dataGridSystem.Rows.Add("RD Command", "");
            dataGridSystem.Rows.Add("Scan Twice", "");
            dataGridSystem.Rows.Add("Scan Direction", "");
            dataGridSystem.Rows.Add("CN Duplication", "");
            dataGridSystem.Rows.Add("CN Cross", "");
            dataGridSystem.Rows.Add("NG To Output", "");
            dataGridSystem.Rows.Add("Pass To NG", "");
            dataGridSystem.Rows.Add("One Site Empty", "");
            dataGridSystem.Rows.Add("", "");
            dataGridSystem.Rows[13].Selected = true;
            dataGridSystem.DefaultCellStyle = GlobalVar.dataGridStyle;

            dataGridPCBCount.Rows.Clear();
            dataGridPCBCount.Rows.Add("SITE", "");
            dataGridPCBCount.Rows.Add("TOTAL", "");
            dataGridPCBCount.Rows.Add("", "");
            dataGridPCBCount.Rows[2].Selected = true;
            dataGridPCBCount.DefaultCellStyle = GlobalVar.dataGridStyle;
            #endregion
            ...
            //frmOrigin = new Origin();
            frmOrigin.FormBorderStyle = FormBorderStyle.None;
            frmOrigin.TopMost = true;
            frmOrigin.Dock = DockStyle.Fill;
            frmOrigin.TopLevel = false;
            tpOrigin.Controls.Clear();
            ...
            while (true)
            {
                ...
                {
                    if (!FuncInline.InitDone[i])
                    {
                        inited = false;
                        not_inited += ((FuncInline.enumInitialize)i).ToString() + ", ";
                    }
                }

                if (initWatch.ElapsedMilliseconds > 90 * 1000)
                {
                    FuncError.AddError(new FuncInline.structError(DateTime.Now.ToString("yyyyMMdd"),
                                                DateTime.Now.ToString("HH:mm:ss"),
                                                FuncInline.enumErrorPart.System,
                                                FuncInline.enumErrorCode.System_Init_Fail,
                                                false,
                                                "System Initialize failed. Check " + not_inited));
                    break;
                }

                if (inited)
                {
                    Controller.MachineInitDone = true;

                    dlgLoading.Close();
                    break;
                }

                dlgLoading.RefreshStep();
                dlgLoading.Focus();
                Thread.Sleep(1000);
            }
            #endregion
        ...
        private void frmMain_FormClosed(object sender, FormClosedEventArgs e) // 프로그램 종료시
        {
            ...
            if (!Controller.initFail)
            {
                ...
                #region Test Port 연결해제, Scanner Port 연결해제
                for (int i = 0; i < FuncInline.ComSMD.Length; i++)
                {
                    FuncInline.ComSMD[i].Disconnect();
                }
            ...
            try
            {
                             ...
                             this.InvokeRequired)
                {
                    this.Invoke(new MethodInvoker(delegate ()
                    {
                        ...
                        lbInShuttle.Text = ((AutoInline)GlobalVar.Class).InShuttle.Action.ToString();
                        lbFrontRack.Text = ((AutoInline)GlobalVar.Class).FrontRack.Action.ToString();
                        lbRearRack.Text = ((AutoInline)GlobalVar.Class).RearRack.Action.ToString();
                        lbOutShuttle.Text = ((AutoInline)GlobalVar.Class).OutShuttle.OutShuttleAction.ToString();
                        lbOutConveyor.Text = ((AutoInline)GlobalVar.Class).OutShuttle.OutConveyorAction.ToString();
                        lbScan.Text = ((AutoInline)GlobalVar.Class).Scan.Action.ToString();
                        #endregion
                        ...
                        pnOutShuttleUp.BackColor = (FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.OutShuttle_Up].PCBStatus == FuncInline.enumSMDStatus.Test_Fail ||
                        FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.OutShuttle_Up].PCBStatus == FuncInline.enumSMDStatus.Test_Cancel ||
                        FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.OutShuttle_Up].PCBStatus == FuncInline.enumSMDStatus.User_Cancel ||
                        FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.OutShuttle_Up].PCBStatus == FuncInline.enumSMDStatus.Test_Timeout) ? Color.Tomato : // NG 경우 적색
                        ...
                        #region 상단
                        //배경 상태표시
                        pnLift1Up.BackColor = FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.Lift1_Up].PCBStatus == FuncInline.enumSMDStatus.Test_Fail ||
                        FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.Lift1_Up].PCBStatus == FuncInline.enumSMDStatus.Test_Cancel ||
                        FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.Lift1_Up].PCBStatus == FuncInline.enumSMDStatus.User_Cancel ||
                        FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.Lift1_Up].PCBStatus == FuncInline.enumSMDStatus.Test_Timeout ? Color.Tomato : // NG 경우 적색
                        ...
                        FuncForm.SetButtonColor2(btnSmemaBeforeAuto, DIO.GetDIData(FuncInline.enumDINames.X00_7_SMEMA_After_AutoInline));
                        ...
                        FuncForm.SetButtonColor2(btnSmemaAfterAuto, DIO.GetDORead((int)FuncInline.enumDONames.Y404_3_SMEMA_Before_AutoInline));
        ...
        private void pbTeaching_Click(object sender, EventArgs e)
        {
            ...
            FuncLog.WriteLog("Main - Teaching Click");
        ...
        private void pbTrace_Click(object sender, EventArgs e)
        {
            ...
            //*/
            FuncLog.WriteLog("Main - Trace Click");
            //ClearSubMenu();
            //pbTrace.BackgroundImage = Radix.Properties.Resources.sub_trace_sel;
        ...
        */
            ...
            try
            {
                    ...
                    !GlobalVar.GlobalStop)
                {
                    ...
                    if (GlobalVar.Init_Finish)
                    {
                        ...
                        if (FuncWin.MessageBoxOK("PCB width changed. Run width change?"))
                        {
                ...
                #region 초기화 실패 사유 조합
                string stat = "";
                stat += AutoInline.Class.InShuttle.Log + "\n";
                stat += AutoInline.Class.FrontRack.Log + "\n";
                stat += AutoInline.Class.RearRack.Log + "\n";
                stat += AutoInline.Class.OutShuttle.Log + "\n";
                stat += AutoInline.Class.Scan.Log + "\n";
                ...
                for (int i = 0; i < FuncInline.NeedPartClear.Length; i++)
                {
                    ...
                    switch (part)
                    {
                        ...
                        case FuncInline.enumErrorPart.OutShuttle_Up:
                            ...
                            hasStopper = true; stopperDO = FuncInline.enumDONames.Y300_2_Out_Shuttle_CONTACT_STOPPER_Out_SOL;
                            break;
                        ...
                        case FuncInline.enumErrorPart.OutShuttle_Down:
                            ...
                            hasStopper = true; stopperDO = FuncInline.enumDONames.Y302_1_Out_Shuttle_CONTACT_STOPPER_In_SOL;
                            break;
                        ...
                        default:
                            {
                                    ...
                                    part <= FuncInline.enumErrorPart.Site26_R_FT3)
                                {
                                    ...
                                    // 사이트 컨베이어 모터쌍(CW/CCW)
                                    if (FuncInline.SiteIoMaps.TryGetSiteMotor(pos, out var cw, out var ccw))
                                    {
                    ...
                    FuncLog.WriteLog($"PartClear - {pos}");
                    ...
                    switch (part)
                    {
                        ...
                        case FuncInline.enumErrorPart.InShuttle:
                            DIO.WriteDOData(FuncInline.enumDONames.Y4_2_SMEMA_Before_Ready, false);
                            AutoInline.Class.InShuttle.Action = InShuttle.enumAction.Waiting;
                            break;
        ...
        private void btnInput_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (AutoInline.Class.InShuttle.Action != InShuttle.enumAction.Waiting ||
        ...
        {
            GlobalVar.MasterChecked = AutoInline.CheckAXL();
        }
        ...
        private void tmrCheck_Tick(object sender, EventArgs e)
        {
            switch (GlobalVar.SystemStatus)
            {
                ...
                case enumSystemStatus.OutputStop:
                    lblSystemStatus.Text = "AutoRun ( " + GlobalVar.SystemStatus.ToString() + " )";
                    break;
                default:
                    lblSystemStatus.Text = GlobalVar.SystemStatus.ToString();
                    break;
            }
            ...
            for (int i = 0; i < FuncInline.ArrayUse.Length; i++)
            {
                if (FuncInline.ArrayUse[i])
                {
                    arrayList += (i + 1).ToString() + " ";
                    pbaCount++;
                }
            }


            if (dataGridModel.Rows.Count >= 1)
            {
                dataGridModel.Rows[0].Cells[1].Value = GlobalVar.ModelName;
            }
            if (dataGridModel.Rows.Count >= 2)
            {
                dataGridModel.Rows[1].Cells[1].Value = FuncInline.PCBWidth.ToString("F2") + " mm";
            }
            if (dataGridModel.Rows.Count >= 3)
            {
                dataGridModel.Rows[2].Cells[1].Value = FuncInline.PCBLength.ToString("F2") + " mm";
            }
            if (dataGridModel.Rows.Count >= 4)
            {
                dataGridModel.Rows[3].Cells[1].Value = FuncInline.TestType == FuncInline.enumTestType.All ? "Download & Function" : FuncInline.TestType.ToString();
            }
            if (dataGridModel.Rows.Count >= 5)
            {
                dataGridModel.Rows[4].Cells[1].Value = FuncInline.TestTimeout.ToString() + " sec";
            }
            if (dataGridModel.Rows.Count >= 6)
            {
                dataGridModel.Rows[5].Cells[1].Value = arrayList + "(" + pbaCount + "PBA)";
            }
            if (dataGridModel.Rows.Count >= 7)
            {
                string strXOut = "";
                for (int i = 0; i > FuncInline.XOut.Length; i++)
                {
                    if (FuncInline.XOut[i])
                    {
                        strXOut += (i + 1).ToString() + " ";
                    }
                }
                if (strXOut == "")
                {
                ...
                dataGridModel.Rows[6].Cells[1].Value = strXOut;
            }
            if (dataGridModel.Rows.Count >= 8)
            {
                string strXout = "No XOut";
                if (FuncInline.XoutByVision)
                {
                    strXout = "Pass to " + (FuncInline.XoutToNG ? "NG" : "Output");
                }
                dataGridModel.Rows[7].Cells[1].Value = strXout;
            }
            if (dataGridModel.Rows.Count >= 9)
            {
                string strBad = "No BadMark";
                if (FuncInline.UseBadMark)
                {
                    strBad = "Pass to " + (FuncInline.BadMarkToNG ? "NG" : "Output");
                }
                dataGridModel.Rows[8].Cells[1].Value = strBad;
            }
            #endregion

            if (simulationPCBInput &&
                    GlobalVar.SystemStatus >= enumSystemStatus.AutoRun &&
                    FuncInline.PCBInfo[(int)FuncInline.enumTeachingPos.InConveyor].PCBStatus == FuncInline.enumSMDStatus.UnKnown &&
                    FuncInline.InConveyorAction == FuncInline.enumLiftAction.Input &&
                    !DIO.GetDIData(FuncInline.enumDINames.X302_0_In_Shuttle_Pcb_In_Sensor) &&
                    !DIO.GetDIData(FuncInline.enumDINames.X302_1_In_Shuttle_Pcb_Stop_Sensor))
            {
                DIO.WriteDIData(FuncInline.enumDINames.X302_0_In_Shuttle_Pcb_In_Sensor, true);
            }
            ...
            #region 생산카운트
            dataGridCount.Rows[0].Cells[0].Value = "Shift " + FuncInline.NowShift;
            if (dataGridCount.Rows.Count > 0)
            {
                dataGridCount.Rows[1].Cells[1].Value = FuncInline.ArrayInputCount.ToString();
            }
            if (dataGridCount.Rows.Count > 1)
            {
                dataGridCount.Rows[2].Cells[1].Value = FuncInline.ArrayPassCount.ToString();
            }
            if (dataGridCount.Rows.Count > 2)
            {
                dataGridCount.Rows[3].Cells[1].Value = FuncInline.ArrayDefectCount.ToString();
            }
            if (FuncInline.ArrayInputCount == 0)
            {
                dataGridCount.Rows[4].Cells[1].Value = "-";
            }
            else
            {
                dataGridCount.Rows[4].Cells[1].Value = ((double)FuncInline.ArrayDefectCount / (double)FuncInline.ArrayInputCount * 100).ToString("F1");
            }

            if (dataGridCount.Rows.Count > 0)
            {
                dataGridCount.Rows[1].Cells[2].Value = FuncInline.PCBInputCount.ToString();
            }
            if (dataGridCount.Rows.Count > 1)
            {
                dataGridCount.Rows[2].Cells[2].Value = FuncInline.PCBPassCount.ToString();
            }
            if (dataGridCount.Rows.Count > 2)
            {
                dataGridCount.Rows[3].Cells[2].Value = FuncInline.PCBDefectCount.ToString();
            }
            if (FuncInline.PCBInputCount == 0)
            {
                dataGridCount.Rows[4].Cells[2].Value = "-";
            }
            else
            {
                dataGridCount.Rows[4].Cells[2].Value = ((double)FuncInline.PCBDefectCount / (double)FuncInline.PCBInputCount * 100).ToString("F1");
            }


            #region PCB 카운트
            //lblTotalCount.Text = "PCB Count\n\nSite : " + sitePCB + " / " + siteTotal + "\n\nTotal : " + totalPCB;
            dataGridPCBCount.Rows[0].Cells[1].Value = FuncInline.GetPCBCount(false) + " / " + FuncInline.GetValidSiteCount();
            dataGridPCBCount.Rows[1].Cells[1].Value = FuncInline.GetPCBCount(true).ToString();

            //debug("PCB TOTAL : " + totalPCB.ToString());
            //debug("CARRIER TOTAL : " + FuncInline.GetJigLiftCount(true));
            #endregion
                ...
                GlobalVar.SystemStatus != enumSystemStatus.ErrorStop)
            {
                ...
                if (FuncInline.CheckNoPCB() &&
                    GlobalVar.TickCount64 - GlobalVar.OutputTime > (ulong)GlobalVar.OutStopTime * 1000)
                {
                    GlobalVar.SystemStatus = enumSystemStatus.OutputStop;
                }
                else if (GlobalVar.TickCount64 - GlobalVar.InputTime > (ulong)GlobalVar.InStopTime * 1000)
                {
            ...
            {
                //FuncInline.structError er = new FuncInline.structError(DateTime.Now.ToString("yyyyMMdd"),
                //                                DateTime.Now.ToString("HH:mm:ss"),
                //                                FuncInline.enumErrorPart.System,
                //                                FuncInline.enumErrorCode.No_Error,
                //                                false,
                //                                "");
                FuncInline.structError er = new FuncInline.structError();
                GlobalVar.SystemErrorQueue.TryDequeue(out er);
                if (((FuncInline.structError)er).ErrorCode != FuncInline.enumErrorCode.No_Error &&
                    ((FuncInline.structError)er).ErrorCode != FuncInline.enumErrorCode.E_Stop &&
                    ((FuncInline.structError)er).ErrorCode != FuncInline.enumErrorCode.Loto_Off &&
                    ((FuncInline.structError)er).ErrorCode != FuncInline.enumErrorCode.Light_Curtain_Checked &&
                    ((FuncInline.structError)er).ErrorCode != FuncInline.enumErrorCode.Door_Opened)
                {
                    ...
                    GlobalVar.ErrorDialog = new ErrorDialog((FuncInline.structError)er);
                    GlobalVar.ErrorDialog.Owner = this;
                    GlobalVar.ErrorDialog.Show();
                    ...
                    #endregion
                    GlobalVar.ErrorDialog.Left = sc[firstScreen].Bounds.Right / 2 - GlobalVar.ErrorDialog.Width / 2;
                    GlobalVar.ErrorDialog.Top = sc[firstScreen].Bounds.Bottom / 2 - GlobalVar.ErrorDialog.Height / 2;
                    ClearSubMenu();
                }
            }
            else if (FuncInline.BuyerChangeBeforeCheck &&
                FuncInline.BuyerChangeBeforeEnd) // BuyerChange 테스트 S/W 변경 알림
            {
                FuncInline.BuyerChangeBeforeCheck = false; // 더 이상 체크 안 하게 한다.
                #region 에러창 떠 있으면 닫고 다른 창을 연다
                try
                {
                    Form fc = Application.OpenForms["ErrorDialog"];
                ...
                FuncInline.structError er = new FuncInline.structError(DateTime.Now.ToString("yyyyMMdd"),
                                                DateTime.Now.ToString("HH:mm:ss"),
                                                FuncInline.enumErrorPart.System,
                                                FuncInline.enumErrorCode.Operator_Call,
                                                false,
                                                "BuyerChange before buyer ended. Change test s/w.");

                GlobalVar.ErrorDialog = new ErrorDialog(er);
                GlobalVar.ErrorDialog.Owner = this;
                GlobalVar.ErrorDialog.Show();
                Screen[] sc = Screen.AllScreens; // 모니터 정보
                #region 모니터 해상도 확인
            ...
            /*
            if (DIO.GetDIChange(FuncInline.enumDINames.X00_1_Reset_Switch) &&
                DIO.GetDIData(FuncInline.enumDINames.X00_1_Reset_Switch) &&
                GlobalVar.SystemErrored)
            {
                GlobalVar.EnableBuzzer = false;
            }
            //*/
            //DIO.WriteDOData(FuncInline.enumDONames.Y00_5_OP_Reset_On, GlobalVar.SystemErrored);
            #endregion

            #region 10분 지났으면 관리자 권한 해제
            if (GlobalVar.PwdPass &&
                GlobalVar.PwdWatch.IsRunning &&
                GlobalVar.PwdWatch.ElapsedMilliseconds > 10 * 60 * 1000)
            {
                GlobalVar.PwdPass = false;
        ...
        private void btnInputStop1_Click(object sender, EventArgs e)
        {

            //GlobalVar.SystemStatus = enumSystemStatus.Manual;
            FuncInline.enumErrorPart ErrorPart = FuncInline.enumErrorPart.Lift1_Up;
            FuncError.AddError(new FuncInline.structError(DateTime.Now.ToString("yyyyMMdd"),
                                                               DateTime.Now.ToString("HH:mm:ss"),
                                                               ErrorPart,
                                                               ...
                                                               false,
                                                               $"{Name} Test"));
            ErrorPart = FuncInline.enumErrorPart.FrontPassLine;
            FuncError.AddError(new FuncInline.structError(DateTime.Now.ToString("yyyyMMdd"),
                                                               DateTime.Now.ToString("HH:mm:ss"),
                                                               ErrorPart,
                                                               FuncInline.enumErrorCode.PCB_Info_Move_Fail,
        ...
        private void btnInputStop_Click(object sender, EventArgs e)
        {
            string enable = "Enable";
            if (FuncInline.InStop)
            {
                enable = "Disable";
            }
            if (FuncWin.MessageBoxOK(enable + " PCB Input Stop?"))
            {
                FuncLog.WriteLog("Main - InputStop Click");
                FuncInline.InStop = !FuncInline.InStop;
