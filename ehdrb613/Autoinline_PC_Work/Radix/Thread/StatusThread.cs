                    ...
                    switch (GlobalVar.MasterType)
                    {
                        ...
                        case enumMasterType.AXL:
                            ...
                            for (ushort axis = 0; axis < GlobalVar.Axis_count; axis++) // 전체 서보 모터 갯수대로
                            {
                                ...
                                GlobalVar.AxisStatus[axis].Position = FuncMotion.GetRealPosition(axis, dActPosition); //FuncMotion.PulseToMM((long)dActPosition, GlobalVar.ServoGearRatio[(int)axis], GlobalVar.ServoRevMM[(int)axis], GlobalVar.ServoRevPulse[(int)axis]);//dActPosition; // 서보 포지션
                        ...
                        case enumMasterType.ADVANTECH:
                            ...
                            for (ushort axis = 0; axis < GlobalVar.Axis_count; axis++) // 전체 서보 모터 갯수대로
                            {
                                ...
                                //if (GlobalVar.AxisStatus[axis].Errored)
                                //{
