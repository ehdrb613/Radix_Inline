                    ...
                    if (FuncLetsMotion.initialized && FuncLetsMotion.Scan_initialized )//연결완료 되었으면 진행
                    {
                        for (int axis = 0; axis < GlobalVar.LetsAxis_count; axis++) // 전체 스텝 모터 갯수대로
                        {
                            if (!GlobalVar.LetsHoming)
                            {
                                ...
                                GlobalVar.LetsAxisStatus[axis].Position = FuncLetsMotion.GetRealPos((FuncInline.enumLetsAxis)axis, position);  //위치값 옵셋값 적용표시 
                        ...
                        if ((GlobalVar.LetsAxisStatus[0].StandStill && GlobalVar.LetsAxisStatus[0].isHomed) &&
                            (GlobalVar.LetsAxisStatus[1].StandStill && GlobalVar.LetsAxisStatus[1].isHomed) &&
                            (GlobalVar.LetsAxisStatus[2].StandStill && GlobalVar.LetsAxisStatus[2].isHomed) &&
                            (GlobalVar.LetsAxisStatus[3].StandStill && GlobalVar.LetsAxisStatus[3].isHomed) &&
                            (FuncInline.InlineType >= FuncInline.enumInlineType.Gen5 ?
                            (GlobalVar.LetsAxisStatus[4].StandStill && GlobalVar.LetsAxisStatus[4].isHomed) :
                            true))
                        {
