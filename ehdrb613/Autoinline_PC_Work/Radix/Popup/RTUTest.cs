...
namespace Radix
{
    public partial class RTUTest : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            //if (Rtu.Connected())
            //{
            //    GetposTextbox_X.Text = GlobalVar.LetsAxisStatus[0].Position.ToString("F3");
            //    GetposTextbox_Y.Text = GlobalVar.LetsAxisStatus[1].Position.ToString("F3");
            //}
        }
        ...
        {
            FuncInline.enumLetsAxis ax = (FuncInline.enumLetsAxis)AxisList.SelectedIndex;
