    ...
    public static class Func
    {
       ...
       //*/
        ...
        public static bool LaserMarkCont(structPosition pos, bool turn, bool is2D, string text)
        {
            ...
            FuncLog.WriteLog("LaserMarkCont " + pos.x + "," + pos.y + "," + pos.z + " " + is2D + " " + text);
            int startTime = Environment.TickCount;
            if (pos.x != 0 ||
                pos.y != 0 ||
                pos.z != 0 ||
        ...
        */
        ...
        public static void LoadMachinenIni() // 장비의 모든 설정 읽기
        {
            try
            {
                ...
                FuncInline.LiftSpeed = int.Parse(FuncFile.ReadIniFile(Section, "LiftSpeed", IniPath, "150"));
                FuncInline.LiftAccDec = int.Parse(FuncFile.ReadIniFile(Section, "LiftAccDec", IniPath, "1"));
                GlobalVar.WidthHomSpeed = int.Parse(FuncFile.ReadIniFile(Section, "WidthHomSpeed", IniPath, "1"));
                GlobalVar.WidthSpeed = int.Parse(FuncFile.ReadIniFile(Section, "WidthSpeed", IniPath, "1"));
                GlobalVar.WidthAccDec = int.Parse(FuncFile.ReadIniFile(Section, "WidthAccDec", IniPath, "1"));
                ...
                FuncInline.DefaultPCBWidth = double.Parse(FuncFile.ReadIniFile(Section, "DefaultPCBWidth", IniPath, "250"));
        ...
        public static void LoadTestSiteIni() // 장비의 모든 설정 읽기
        {
            try
            {
                ...
                FuncInline.BuyerChangeSite[0] = FuncInline.enumTeachingPos.Site1_F_DT1 + (int.Parse(testSite1.Substring("Site".Length).Split('_')[0]) - 1);
                string testSite2 = FuncFile.ReadIniFile(Section, "BuyerChangeSite2", IniPath, "Site8");
                FuncInline.BuyerChangeSite[1] = FuncInline.enumTeachingPos.Site1_F_DT1 + (int.Parse(testSite1.Substring("Site".Length).Split('_')[0]) - 1);
                string testSite3 = FuncFile.ReadIniFile(Section, "BuyerChangeSite3", IniPath, "Site15");
                FuncInline.BuyerChangeSite[2] = FuncInline.enumTeachingPos.Site1_F_DT1 + (int.Parse(testSite1.Substring("Site".Length).Split('_')[0]) - 1);
                #endregion
            }
            catch (Exception ex)
            {
        ...
        public static void LoadTeachingWidthIni()
        {
            try
            {
                ...
                {
                    FuncInline.OffsetWidth[i] = double.Parse(FuncFile.ReadIniFile(Section, "TeachingWidth" + i, IniPath, "0"));
                    FuncInline.TeachingWidth[i] = FuncInline.PCBWidth + FuncInline.OffsetWidth[i]; // apply건 load건 티칭계산이 다시 되었으면 티칭좌표에 적용

                    FuncInline.WidthDisplayReverse[i] = true; // 디스플레이상 표기 바꾸기위해
                }
        ...
        public static void LoadSiteOrder() // 사이트 투입 순서 읽기
        {
            try
            {
                ...
                for (int i = 0; i < FuncInline.SiteOrder.Length; i++)
                {
                    FuncInline.SiteOrder[i] = FuncInline.enumTeachingPos.Site1_F_DT1 + int.Parse(FuncFile.ReadIniFile(Section, "SiteOrder" + i, IniPath, "Site1").Substring("Site".Length).Split('_')[0]) - 1;
                }
        ...
        public static void SaveTeachingWidthIni()
        {
            try
            {
                ...
                for (int i = 0; i < FuncInline.OffsetWidth.Length; i++)
                {
                    FuncFile.WriteIniFile(Section, "TeachingWidth" + i, FuncInline.OffsetWidth[i].ToString(), IniPath);
                    
                    //if ((FuncInline.enumTeachingPos)i != FuncInline.enumTeachingPos.LoadiNgShuttle)
                    //{
                    // 티칭좌표에는 저장이 안 되어 있어 티칭좌표 수정
                    FuncInline.TeachingWidth[i] = FuncInline.OffsetWidth[i] + FuncInline.PCBWidth;
                    //}
                }
        ...
        public static void LoadModelIni() // 모델의 모든 설정 읽기
        {
            try
            {
                ...
                FuncInline.ArrayCount = int.Parse(FuncFile.ReadIniFile(Section, "ArrayCount", IniPath, "6"));
                ...
                for (int i = 0; i < FuncInline.ArrayUse.Length; i++)
                {
                    int front = i + 1;   // 1~6
                    int rear = i + 7;   // 7~12
                    FuncInline.ScanTeachingPos[front].x = double.Parse(FuncFile.ReadIniFile(Section, "Front_ArrayPos_X" + i, IniPath, "0"));
                    FuncInline.ScanTeachingPos[front].y = double.Parse(FuncFile.ReadIniFile(Section, "Front_ArrayPos_Y" + i, IniPath, "0"));

                    FuncInline.ScanTeachingPos[rear].x = double.Parse(FuncFile.ReadIniFile(Section, "Rear_ArrayPos_X" + i, IniPath, "0"));
                    FuncInline.ScanTeachingPos[rear].y = double.Parse(FuncFile.ReadIniFile(Section, "Rear_ArrayPos_Y" + i, IniPath, "0"));
                }
                ...
                FuncInline.LongPCBTest = FuncFile.ReadIniFile(Section, "LongPCBTest", IniPath, "False") == "True";
        ...
        public static void SaveModelIni() // 모델의 모든 설정 쓰기
        {
            try
            {
                ...
                for (int i = 0; i < FuncInline.ArrayUse.Length; i++)
                {
                    ...
                    FuncFile.WriteIniFile(Section, "Front_ArrayPos_X" + i, FuncInline.ScanTeachingPos[front].x.ToString(), IniPath);
                    FuncFile.WriteIniFile(Section, "Front_ArrayPos_Y" + i, FuncInline.ScanTeachingPos[front].y.ToString(), IniPath);

                    FuncFile.WriteIniFile(Section, "Rear_ArrayPos_X" + i, FuncInline.ScanTeachingPos[rear].x.ToString(), IniPath);
                    FuncFile.WriteIniFile(Section, "Rear_ArrayPos_Y" + i, FuncInline.ScanTeachingPos[rear].y.ToString(), IniPath);
                }
                ...
                FuncFile.WriteIniFile(Section, "LongPCBTest", FuncInline.LongPCBTest.ToString(), IniPath);
        ...
        public static void LoadPortIni() // 포트의 모든 설정 읽기
        {
            try
            {
                ...
                FuncInline.PortScanner = int.Parse(FuncFile.ReadIniFile(Section, "PortScanner", IniPath, "COM1").Replace("COM", ""));
                ...
                FuncInline.BaudScanner = int.Parse(FuncFile.ReadIniFile(Section, "BaudScanner", IniPath, "9600"));
                ...
                FuncInline.ParityScanner = Util.ParseParity(FuncFile.ReadIniFile(Section, "ParityScanner", IniPath, "None"));
                ...
                FuncInline.StopBitsScanner = Util.ParseStopBits(FuncFile.ReadIniFile(Section, "StopBitsScanner", IniPath, "One"));

                if(FuncInline.InlineType >= FuncInline.enumInlineType.Gen6)
                {
                    //빌딩층빼고 다 사용안함
                    FuncInline.PortTest[1] = int.Parse("COM99".Replace("COM", ""));
                    FuncInline.PortTest[2] = int.Parse("COM98".Replace("COM", ""));
                    FuncInline.PortTest[3] = int.Parse("COM97".Replace("COM", ""));
                    FuncInline.PortTest[4] = int.Parse("COM96".Replace("COM", ""));
                    FuncInline.PortTest[5] = int.Parse("COM95".Replace("COM", ""));
                    FuncInline.PortTest[6] = int.Parse("COM94".Replace("COM", ""));
                    FuncInline.PortTest[7] = int.Parse("COM93".Replace("COM", ""));
                    FuncInline.PortTest[8] = int.Parse("COM92".Replace("COM", ""));

                }
                else if(FuncInline.InlineType < FuncInline.enumInlineType.Gen5)
                {
                    //펑션4층은 사용안함
                    FuncInline.PortTest[4] = int.Parse("COM99".Replace("COM", ""));
                    FuncInline.PortTest[8] = int.Parse("COM98".Replace("COM", ""));
                }
        ...
        public static void SavePortIni() // 포트의 모든 설정 쓰기
        {
            try
            {
                ...
                FuncFile.WriteIniFile(Section, "PortScanner", FuncInline.PortScanner.ToString(), IniPath);
                ...
                FuncFile.WriteIniFile(Section, "BaudScanner", FuncInline.BaudScanner.ToString(), IniPath);
                ...
                FuncFile.WriteIniFile(Section, "ParityScanner", FuncInline.ParityScanner.ToString(), IniPath);
                ...
                FuncFile.WriteIniFile(Section, "StopBitsScanner", FuncInline.StopBitsScanner.ToString(), IniPath);
        ...
        public static bool StopShuttle()
        {

            FuncMotion.MoveStop((int)FuncInline.enumServoAxis.SV00_In_Shuttle);
            FuncMotion.MoveStop((int)FuncInline.enumServoAxis.SV01_Out_Shuttle);
        ...
        public static bool StopScan()
        {
            ...
            FuncMotion.MoveStop((int)FuncInline.enumServoAxis.SV06_Scan_Y);
            FuncMotion.MoveStop((int)FuncInline.enumServoAxis.SV07_Scan_X);
