    ...
    public partial class Origin : Form
    {
            ...
            try
            {
                if (!GlobalVar.GlobalStop && this.InvokeRequired)
                {
                    this.Invoke(new MethodInvoker(() =>
                    {
                        ...
                        originDone[(int)FuncInline.enumInitialize.RearLift] = FuncInlineAction.CheckOriginDone(FuncInline.enumInitialize.RearLift);
                        ...
                        PaintButton(btnLift2, (int)FuncInline.enumInitialize.RearLift);
        ...
        private void TimerOrigin()
        {
            ...
            try
            {
                ...
                while (!GlobalVar.GlobalStop && watch.ElapsedMilliseconds < 60 *1000)
                {
                    ...
                    RunOriginIfSelected((int)FuncInline.enumInitialize.RearLift, FuncInline.enumInitialize.RearLift, ref allDone);
        ...
        private void Site_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (name == "btnLift2") { Toggle((int)FuncInline.enumInitialize.RearLift); return; }
        ...
        private void btnOrigin_Click(object sender, EventArgs e)
        {
            ...
            // Lift2 (상/하 모두 체크)
            if (posSelect[(int)FuncInline.enumInitialize.RearLift] && !originDone[(int)FuncInline.enumInitialize.RearLift])
            {
