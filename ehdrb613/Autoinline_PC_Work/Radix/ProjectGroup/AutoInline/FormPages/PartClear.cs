...
namespace Radix
{
    ...
    public partial class PartClear : Form
    {
        ...
        private void TimerCheck(Object state)
        {
            ...
            try
            {
                    ...
                    this.Invoke(new MethodInvoker(delegate ()
                {
                    ...
                    {
                        int.TryParse(pcbBtns[i].Name.Replace("btnSite", ""), out siteIndex);
                        siteIndex--;
                    ...
                    //FuncLog.WriteLog("manual ui time : " + (Environment.TickCount - startTime).ToString());
                }));
                }
        ...
        private bool btnPartClear_Click()
        {
            ...
            switch (activeButton.Name)
            {
                ...
                case "btnOut_Shuttle_Up":
                    ...
                    stopperDown = FuncInline.enumDONames.Y300_2_Out_Shuttle_CONTACT_STOPPER_Out_SOL;
                    stopperDown2 = FuncInline.enumDONames.Y302_1_Out_Shuttle_CONTACT_STOPPER_In_SOL;
                    break;
                case "btnOut_Shuttle_Down":
                    if (GlobalVar.Simulation)
                    {
                ...
                case "btnSite26":
                    ...
                    if (FuncInline.SiteIoMaps.TryGetSiteMotor(pos, out var docw,out var doccw))
                    {
            ...
            switch (activeButton.Name)
            {
                ...
                case "btnFrontScan":
                    ...
                    AutoInline.Class.FrontRack.ScanSiteAction = FrontRack.enumScanSiteAction.Waiting;
                ...
                case "btnSite26":
                    ...
                    if (FuncInline.SiteIoMaps.TryGetSiteMotor(pos, out var docw, out var doccw))
                    {
                        DIO.WriteDOData(docw, false);
                        DIO.WriteDOData(doccw, false);
        ...
        {
            GlobalVar.SystemStatus = GlobalVar.SystemStatus <= enumSystemStatus.Initialize ?
                enumSystemStatus.BeforeInitialize : enumSystemStatus.Manual;
